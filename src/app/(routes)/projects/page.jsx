    ...
    return (
        <main className={styles.main}>
            ...
            <container className={styles.section4}>
                ...
                <p className={styles.copywritingText}>I have a degree in literature so naturally I know and love good writing. And through my experience in marketing, I have also come to know and love good copy. Some of my achiements include managing a blog - editing every piece and writing my own - with a readership of 20k, translating a German text for publication in English, and of course, writing 100s of social media captions. I&apos;ve selected some of my favourite posts below that represent my best work.</p>   
