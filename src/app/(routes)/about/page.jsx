    ...
    return (
        <main className={styles.main}>
            ...
            <h1 className={styles.aboutH1}>About Me.</h1>
                ...
                When I&apos;m not deep into tech, you&apos;ll find me fulfilling all my basic needs with coffee and RuPaul&apos;s Drag Race. I&apos;m a film and literature girlie, having got my degree in languages from the University of Oxford (fun fact - I&apos;ve got a least a bit of working knowledge of all the languages on the homepage) and I think literally anything can be improved with a cat. Get in touch and we can chat design and branding, or Russian lit and all things K-Pop. I can yap about it all.</p></div>
            </div>
